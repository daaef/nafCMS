		...
		<div class="auth-wrapper d-flex no-block justify-content-center align-items-center" style="background:url(../../assets/images/big/auth-bg.jpg) no-repeat center center;">
            ...
            @endif 
								...
								<div class="input-group mb-3">
									...
									<input type="text" class="form-control form-control-lg" name=login placeholder="Username or Email" value="{{ old('email') }}" aria-label="Username" aria-describedby="basic-addon1">
								</div>
								<div class="input-group mb-3">
									<div class="input-group-prepend">
				...
				<div id="recoverform">
					...
					<div class="row m-t-20">
						<!-- Form -->
						<form class="col-12" method="post" action="{{ route('password_recovery') }}">
							{{ csrf_field() }}
							<div class="form-group row">
								<div class="col-12">
