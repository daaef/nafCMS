      ...
      <ul class="navbar-nav float-right">
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <img src="{{ Gravatar::fallback('../../assets/images/users/2.png')->get(Sentinel::getUser()->email) }}" alt="user" class="rounded-circle" width="40">
          ...
          <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
            ...
            <div class="d-flex no-block align-items-center p-15 bg-primary text-white m-b-10">
              <div class="">
                <img src="{{ Gravatar::fallback('../../assets/images/users/2.png')->get(Sentinel::getUser()->email) }}" alt="user" class="rounded-circle" width="60">
              </div>
              <div class="m-l-10">
