...
<head>
    ...
    <title>Nigerian Air Force | History</title>
    <!-- Calling Favicon -->
    ...
    <div class="container">
        <div class="row z-5 align-items-center">
            <div class="col-md-8 text-center text-md-left">
                <h1 class="f-700 color-white">History of NAF</h1>
            ...
            <div class="col-md-4 text-center text-md-right">
                <nav aria-label="breadcrumb" class="banner-breadcump">
                    <ol class="breadcrumb justify-content-center">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('about-us') }}">About Us</a>
                        </li>
                        <li class="breadcrumb-item font-weight-bold active" aria-current="page">History of NAF</li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <div class="right-box-content">
                        <div class="categories mb-5">
                            <ul>
                                ...
                                <li>
                                    <a class="font-weight-bold" href="{{ route('history') }}">History of NAF
                                    </a>
                                <li>
