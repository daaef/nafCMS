      ...
      <div class="card">
        <div class="card-body">
          <div class="row" style="margin-bottom: 20px;">
            <div class="col-md-8">
              <h4 class="card-title">List Gallery Images</h4>
            </div>
            ...
            <tbody>
              ...
              @foreach($galleries as $gallery)
                  <tr>
                    ...
                    <td><img src="../uploads/gallery/thumbnails/{{$gallery->image}}"  alt="heloo"></td>                           
                    <td>{{ $gallery->slug }}</td>                    
                    <td>
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="exampleModalLabel1">Add Gallery Image</h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <form class="form p-t-20" method="post" action="{{ route('gallery.store') }}" enctype="multipart/form-data">
  ...
  @foreach($galleries as $modal)
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <form class="form p-t-20" method="post" action="{{ route('gallery.update', $modal->slug) }}" enctype="multipart/form-data">
          <div class="modal-body">
            {{ method_field('PUT') }}
            {{ csrf_field() }}
     ...
     <div class="modal fade bs-example-modal-lg" id="deleteClientModal{{ $modal->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
       <div class="modal-dialog modal-lg" role="document">
         <div class="modal-content">
           ...
           <form class="form p-t-20" method="post" action="{{ route('gallery.delete', $modal->slug)}}" >
             <div class="modal-body">
               {{ csrf_field() }}
               {{ method_field('GET') }}
