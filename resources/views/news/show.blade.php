...
<nav class="main-navigation is-hidden text-inverted">
    <div class="main-navigation-list-wrapper span1 aboutBG">
        <span class="coverer main-navigation-small-background"
              style="background-image: url('img/shot5.png')"></span>
    ...
    <div class="main-navigation-list-wrapper span3 mediaBG">
        <span class="coverer main-navigation-small-background"
              style="background-image: url('img/shot7.png')"></span>
        <dl class="main-navigation-list">
            <dt class="main-navigation-title"
                href="#" style="">Media
            </dt>
    ...
    <div class="main-navigation-list-wrapper span4 howBG">
        <span class="coverer main-navigation-small-background"
              style="background-image: url('img/shot3.png')"></span>
        <dl class="main-navigation-list">
            <dt class="main-navigation-title"
                    ...
                    <div class="story-intro-image-content site-wrapper l grid-wrapper text-left">
                        <div class="grid-item grid-nine-sixteenth story-intro-image-caption text-inverted small-right">
                            <p class="heading-03 quote-copy"
                               data-bind="html: $data.quote, css: {'quote-copy': !$data.quoteMark}">{{ $news->title }}</p>
                        </div>

                        <div class="padding@mobile grid-item grid-one-whole">
