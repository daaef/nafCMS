...
<section id="home">
    ...
    <article data-aos="zoom-in"
        ...
        <div class="site-wrapper">
                ...
                <div class="grid-item grid-four-seventh">
                    <a href="#" class="button-block full-image-grid-item-small">
                        <figure class="full-image-ratio ratio-1-1 is-active">
                            <img src="./assets/pages/img/news-1.jpg"
                                 alt="" style="">
                        </figure><!--/ko-->
                        ...
                        <div class="full-image-caption">
                          <h4 class="heading-07" style="opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">
					                ...
					                <h3 class="copy-intro-01 text-no-margin" style="opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">
					                  ...
					                  {!!strlen($latest->title) > 200 ? substr($latest->title,0,200) : $latest->title!!}...
					                </h3>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="#"
                       class="button-block full-image-grid-item-small">
                        ...
                        <figure class="full-image-ratio ratio-3-2 is-active">
                            <img src="./assets/pages/img/news-2.jpg"
                                 alt="" style="">
                        </figure><!--/ko-->
                        <div class="full-image-caption">
                            <h4 class="heading-07" style="opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">
                            ...
                            <h3 class="copy-intro-01 text-no-margin" style="opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">
                            	{!!strlen($post->title) > 200 ? substr($post->title,0,200) : $post->title!!}...
                            </h3>
                        </div>
                    </a>
                  @endforeach
            ...
            <div class="button-alignment">
              <a href="{{ route('pages.news') }}" class="btn btn-outline-dark btn-lg btn-more">
              	view More
              </a>
            </div>
        </div>
    ...
    <!-- ko ifnot: controller.options.showAll || !controller.options.shareData --><!-- /ko -->
        ...
        <footer class="site-footer">
            ...
            <div class="reset-list marginx footer-nav footer-main-nav">
                <a class="twitter-timeline" data-height="500" data-theme="dark" href="https://twitter.com/NigAirForce">Tweets by Nigeria Airforce</a>
