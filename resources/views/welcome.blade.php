...
<div class="site-header">
    <header class="site-header">
        ...
        <ul class="main-top-nav">
            ...
            <li class="page-label">
                <span class="label-text is-filled"><!--ko text:navPageName-->Home
                    <!--/ko--></span>
            </li>
            <li>
    ...
    <header>
        <div class="video-background" style="background-image: url('assets/pages/assets/img/pia-video-poster.jpeg')">
            <video muted loop autoplay class="video-foreground" id='player' allow="autoplay">
                <source src="assets/pages/assets/vid/video_5.mp4" type="video/mp4"/>
            </video>
...
<footer class="site-footer">
    ...
    <a class="footer-site-logo text-uppercase icon-logo-airforce" href="index.html"></a>
...
<script src="assets/pages/assets/js/noframework.waypoints.min.js"></script>
<script>
    AOS.init({
