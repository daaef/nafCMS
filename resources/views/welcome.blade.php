                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <ul class="submenu">
                                    ...
                                    <li><a href="{{ route('about-us') }}">International Liaison</a></li>
                                    <li>
        ...
        <div class="row mb-55 mb-sm-15">
                ...
                <div class="blog-box relative">
                    <a href="blog-details-slider.html">
                        <div class="blog-img img-lined mr-40 mr-md-00">
                            <img src="/assets/pages/img/logo/logo.png" alt="" class="w-100 contain">
                        </div>
                    </a>
                    <div class="blog-box-text z-10 bg-green-op-9 shadow-4 mb-sm-30">
                        <p class="blue mb-10">
                            <span class="line-before transition-4 color-white">12 AUGUST 2019</span>
                        </p>
                        <h5 class="white f-700 mb-10">
                            <a href="blog-details-slider.html" class="fs-19 capitalize">operation green sweep 3: naf
                                scores major success as jets decimate tactical base..</a>
                        </h5>
                        <a href="blog-details-slider.html" class="text-link-a white fs-13 mb-10 uppercase f-600">Readmore
            ...
            <div class="col-md-6">
                <div class="blog-box relative">
                    <a href="blog-details-slider.html">
                        <div class="blog-img img-lined mr-40 mr-md-00">
                            <img src="assets/pages/img/5651.jpg" alt="" class="w-100">
                        </div>
                    </a>
                    <div class="blog-box-text z-10 bg-green-op-9 shadow-4">
                        <p class="blue mb-10">
                            <span class="line-before transition-4 color-white">10 AUGUST 2019</span>
                        </p>
                        <h5 class="white f-700 mb-10 capitalize">
                            <a href="blog-details-slider.html">naf immortalizes late flying officer abdulrahman bayero,
                                neutralize scores of terrorists ..</a>
                        </h5>
                        <a href="blog-details-slider.html" class="text-link-a white fs-13 mb-10 uppercase f-600">Readmore
                            <i class="fas fa-long-arrow-alt-right ml-10"></i></a>
                    </div>
        ...
        <div class="row mb-20 mb-sm-00">
            <div class="col-md-6">
                <div class="blog-box relative">
                    <a href="blog-details-slider.html">
                        <div class="blog-img img-lined mr-40 mr-md-00">
                            <img src="assets/pages/img/planes.jpg" alt="" class="w-100">
                        </div>
                    </a>
                    <div class="blog-box-text z-10 bg-green-op-9 shadow-4 mb-sm-30">
                        <p class="blue mb-10">
                            <span class="line-before  transition-4 color-white">15 MAY 2019</span>
                        </p>
                        <h5 class="white f-700 mb-10">
                            <a href="blog-details-slider.html" class="fs-19 capitalize">capacity building: naf takes
                                delivery of final batch of super mushshak..</a>
                        </h5>
                        <a href="blog-details-slider.html" class="text-link-a white fs-13 mb-10 uppercase f-600">Readmore
                            <i class="fas fa-long-arrow-alt-right ml-10"></i></a>
                    </div>
            ...
            <div class="col-md-6">
                <div class="blog-box relative">
                    <a href="blog-details-slider.html">
                        <div class="blog-img img-lined mr-40 mr-md-00">
                            <img src="assets/pages/img/5543.jpg" alt="" class="w-100">
                        </div>
                    </a>
                    <div class="blog-box-text z-10 bg-green-op-9 shadow-4">
                        <p class="blue mb-10">
                            <span class="line-before transition-4 color-white">30 JUL 2019</span>
                        </p>
                        <h5 class="white f-700 mb-10 capitalize">
                            <a href="blog-details-slider.html">naf to strengthen ties with bangladesh for capacity..</a>
                        </h5>
                        <a href="blog-details-slider.html" class="text-link-a white fs-13 mb-10 uppercase f-600">Readmore
                            <i class="fas fa-long-arrow-alt-right ml-10"></i></a>
                    </div>
