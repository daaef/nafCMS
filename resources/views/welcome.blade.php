...
<html lang="en">
    ...
    <script>
        ...
        <ul class="main-top-nav">
          ...
          <li class="apply-now-label">
            <a class="label-text" href="career.html">Careers</a>
          </li>
          <li class="page-label">
		...
		@includes('layout.frontend.navbar')
		<section id="home">
    	<header>
        <div class="video-background" style="background-image: url('/assets/pages/img/pia-video-poster.jpeg')">
          ...
          <div class="head-container">
            <h1 class="head-title">
              <a href="#" class="typewrite" data-period="500" data-type='[ "WILLING       ", "ABLE       ", "READY       " ]'>
        ...
        <div class="heading-block" data-transition="heading-block-02">
          ...
          <h6 id="textAnimation" data-aos="zoom-in" data-aos-duration="2500" class="text-anime heading-06">
            <span>WELCOME TO THE OFFICIAL WEBSITE OF THE</span>
          </h6>
          <h2 data-aos="fade" data-aos-duration="3000" id="text" class="heading-02 title responsive-title">
            Nigerian Air Force
          </h2>
        ...
        <ul class="reset-list grid-wrapper grid-padding-single">
          <li class="grid-item grid-one-half single-margin-bottom">
            ...
            <div class="button-alignment">
              <a href="{{ route('pages.history') }}" class="btn btn-outline-white btn-more">
                More
              </a>
           	</div>
          </li>
          <li class="grid-item grid-one-half single-margin-bottom">
            <div class="half-margin-bottom">
              ...
              <p class="copy-body-01 null text-light">
                To ensure the integrity of the airspace by gaining and maintaining control of the air while retaining a credible capacity to fulfill
              </p>
            </div>
            <div>
	            <div class="heading-block-more-info">
	              <h6 class="heading-04 s-large">CAS VISION</h6>
	            </div>
              <p class="copy-body-01 null text-light">
								To reposition the NAF into a highly professional and disciplined force through capacity building initiatives for effective, efficient...
							</p>
            </div>
          </li>
          <li class="grid-item grid-one-half single-margin-bottom">
            ...
            <p class="copy-body-01 null text-light">
            	Find out all you need to know about the Nigerian Air Force Publications, exciting Bulletins and various Article...
            </p>
          </li>
          <li class="grid-item grid-one-half single-margin-bottom">
            <div class="heading-block-more-info">
                ...
                <div class="grid-item grid-four-seventh">
                    <a href="#" class="button-block full-image-grid-item-small">
                        <figure class="full-image-ratio ratio-1-1 is-active">
                          <img src="./assets/pages/img/news-1.jpg" alt="" style="">
                        </figure>
    ...
    <ul class="share">
      <li>
        <a href="https://web.facebook.com/hqnigerianairforce/?_rdc=1&_rdr" target="_blank">
  ...
  <span class="icon icon-youtube" style="background-image: none;"><svg
        ...
        @includes('layout.frontend.footer')
