...
<div class="site-header">
    <header class="site-header">
        ...
        <h1 class="header-site-logo icon-logo-airforce"
            href="#" style="background-image: none;">
            <span class="logo-title">Nigerian Air Force</span>
        </h1>

        <ul class="main-top-nav">
            <li class="apply-now-label"><a class="label-text"
                                           href="career.html">Career</a></li>
            <li class="page-label"><span class="label-text is-filled"><!--ko text:navPageName-->Home
                <!--/ko--></span></li>
            <li>
...
<section id="home">
    <header>
        <div class="video-background" style="background-image: url('assets/pages/assets/img/pia-video-poster.jpeg')">
            <video muted loop autoplay class="video-foreground" id='player' allow="autoplay">
                <source src="./vid/video_5.mp4" type="video/mp4"/>
            </video>
    ...
    <article data-aos="zoom-in" data-aos-duration="1500"  id="welcome" class="content-wrapper a-page-intro">
        ...
        <div class="heading-block" data-transition="heading-block-02">
            <!-- ko if: typeof $data.headNumber != "undefined" --><!-- /ko -->

            <!-- ko if: !$data.hideTopline -->
            ...
            <h6 data-aos="zoom-in"
                ...
                <span>t</span><span>o</span> <span>t</span><span>h</span><span>e</span>
                <span>o</span><span>f</span><span>f</span><span>i</span><span>c</span><span>i</span><span>a</span><span>l</span>
                <span>w</span><span>e</span><span>b</span><span>s</span><span>i</span><span>t</span><span>e</span>
                <span>o</span><span>f</span> <span>t</span><span>h</span><span>e</span>
            </h6>
            <h2 data-aos="fade"
            ...
            <div class="button-wrapper-subtitle">
                <!--ko block:{"optional":true,"definition":"button-outline","name":"button"} --><!--/ko-->
            </div>
        ...
        <div class="site-wrapper text-left">
            ...
            <ul class="reset-list grid-wrapper grid-padding-single">
                <li class="grid-item grid-one-half single-margin-bottom">
                    ...
                    <!--ko block:{"optional":false,"definition":"copy-body-01"} --><p
                        class="copy-body-01 null text-light">
                    ...
                    <div class="button-alignment">
                        <a href="#"
                           class="btn btn-outline-white btn-more" target="">More
                        </a>
                    </div>
                    <!-- /ko -->

                    <!-- ko if: $data.button --><!-- /ko -->
                    <!--/ko-->
                ...
                <li class="grid-item grid-one-half single-margin-bottom">
                    <div class="half-margin-bottom">
                        ...
                        <!--ko block:{"optional":false,"definition":"copy-body-01"} -->
                        <p
                                class="copy-body-01 null text-light">
                            To ensure the integrity of the airspace by gaining and maintaining control of the air while
                            retaining a credible capacity to fulfill
                        </p>
                    </div>
                    <div>
                        ...
                        <p
                                class="copy-body-01 null text-light">
                            To reposition the NAF into a highly professional and disciplined force through capacity
                            building
                            initiatives for effective, efficient...</p>
                    </div>
                </li>
                <li class="grid-item grid-one-half single-margin-bottom">
                    ...
                    <!--ko block:{"optional":false,"definition":"copy-body-01"} --><p
                        class="copy-body-01 null text-light">
                    Find out all you need to know about the Nigerian Air Force Publications, exciting Bulletins and
                    various Article...</p><!--/ko-->
                ...
                >
                    ...
                    Get information about the Nigerian Air Force international missions, collaborations and lots more...
                </p><!--/ko-->
        ...
        <div class="site-wrapper">
            <div class="grid-wrapper home-grid-items text-inverted single-margin-bottom" data-transition="">
                <div class="grid-item grid-four-seventh">
                    <a href="#" class="button-block full-image-grid-item-small">
                        ...
                        <div class="full-image-caption">
                            <h4 class="heading-07" style="opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">
                                <!--ko text:$data.careers()[0].caption-->22/Aug/2019<!--/ko--></h4>
...
<script type='text/javascript' src='js/wp-embed.min-ver=4.9.10.js'></script>
...
<script>
    ...
    document.addEventListener( 'DOMContentLoaded', () => {
        function applyAnimation(els, elementParent) {
            let textAnime = anime({
                targets: els,
                opacity: [
                ...
                duration: 1000,
                delay: anime.stagger(80, {start: 200}) // increase delay by 100ms for each elements.
            });

            const tester = document.querySelector(elementParent);
        ...
        if($('#welcome .text-anime > span')){
            applyAnimation('#welcome .text-anime > span', '#welcome');}
    } );
</script>
</body>
</html>
