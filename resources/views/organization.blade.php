        ...
        <div class="site-header">
            <header class="site-header">
                ...
                <ul class="main-top-nav">
                    ...
                    <li class="page-label">
                <span class="label-text is-filled"><!--ko text:navPageName-->ORGANIZATION
                    <!--/ko--></span>
                    </li>
                    <li>
...
<section id="home" class="organization">
    <div class="view view-faq" style="visibility: visible;">
        ...
        <header class="hero-image text-inverted is-small">
            <div class="hero-image-title">
                ...
                <h1 class="heading-02 title">ORGANIZATION</h1>
            </div>
        </header>
        <section>
            <div data-bind="css : 'block-container ' + (controller.options.extraClassName || '')"
                ...
                <div class="site-wrapper xl content-wrapper content-xsmall-head">
                    <div class="story-intro-image-content organogram site-wrapper l grid-wrapper text-left">
                        <img src="assets/pages/img/organogram.png" alt="">
                    </div>
                </div><!--/ko-->
        </section>
    </div>
...
<script src="jassets/pages/s/isInViewport.jquery.js"></script>
